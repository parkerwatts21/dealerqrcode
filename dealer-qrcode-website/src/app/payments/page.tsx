    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 pt-28 lg:pt-32 pb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          {/* Dealership Card */}
          <div className="bg-white rounded-3xl shadow-lg overflow-hidden border border-neutral-200 transition-all hover:shadow-xl">
            <div className="p-8">
              ...
              <p className="text-neutral-600 mb-6">
                Perfect for individual dealerships looking to accelerate sales with digital innovation. Help customers instantly access vehicle information right on the lot.
              </p>
              
              <a 
                href="https://buy.stripe.com/your-dealership-plan-link" 
                target="_blank"
          ...
          {/* Enterprise Card */}
          <div className="bg-neutral-900 text-white rounded-3xl shadow-lg overflow-hidden border border-neutral-800 transition-all hover:shadow-xl">
            <div className="p-8">
